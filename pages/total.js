		...
		<Layout pagina={'Total y Confirmar Pedido'}>
			...
			>
				...
				<div className='mt-5'>
					<input
						type='submit'
						className={`${comprobarPedido() ? "bg-indigo-100" : "bg-indigo-600 hover:bg-indigo-800"}  w-full lg:w-auto px-5 py-2 rounded uppercase font-bold text-white text-center cursor-pointer transition-all`}
